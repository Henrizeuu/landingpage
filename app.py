...
def init_clients():
    try:
        # Tenta pegar da variável de ambiente primeiro (Cloud Run), se não achar, tenta o secrets (Local)
        apify_token = os.environ.get("APIFY_TOKEN") or st.secrets.get("APIFY_TOKEN")
